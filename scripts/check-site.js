// Run with Node.js 20+: node scripts/check-site.js [--seo]
...
console.log(`PASS: ${pages.length} pages; metadata, headings, local links/anchors, image attributes, sitemap, no analytics${seo ? ', OGP/X cards' : ''}`);
